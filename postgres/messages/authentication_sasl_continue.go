...
func init() {
	connection.InitializeDefaultMessage(AuthenticationSASLContinue{})
}
...
var authenticationSASLContinueDefault = connection.MessageFormat{
...
var _ connection.Message = AuthenticationSASLContinue{}
