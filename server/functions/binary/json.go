...
var json_array_element = framework.Function2{
	...
	Callable: func(ctx *sql.Context, _ [3]pgtypes.DoltgresType, val1 any, val2 any) (any, error) {
		...
		newVal, err := framework.IoInput(ctx, pgtypes.JsonB, val1.(string))
		if err != nil {
			return nil, err
		}
		...
		return framework.IoOutput(ctx, pgtypes.JsonB, retVal)
	},
}
...
var jsonb_array_element_text = framework.Function2{
	...
	Callable: func(ctx *sql.Context, dt [3]pgtypes.DoltgresType, val1 any, val2 any) (any, error) {
		...
		default:
			return framework.IoOutput(ctx, pgtypes.JsonB, pgtypes.JsonDocument{Value: value})
		}
	},
}
