...
// pg_get_triggerdef represents the PostgreSQL system catalog information function taking 1 parameter.
...
// pg_get_triggerdef represents the PostgreSQL system catalog information function taking 2 parameters.
