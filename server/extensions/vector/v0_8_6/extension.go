...
// Extension returns the definition of the emulated extension. The ivfflat and hnsw access methods, their operator
// classes, and their internal support functions are not declared, as extensions cannot declare index access methods.
func Extension() *extdef.Extension {
	return &extdef.Extension{
		...
		Types: []extdef.Type{
			pgvectorType("vector"),
			pgvectorType("halfvec"),
			pgvectorType("sparsevec"),
		},
		Routines:   routines(),
		Operators:  operators(),
		Casts:      castList(),
...
func pgvectorType(name string) extdef.Type {
...
func routines() []extdef.Routine {
	...
	routines = append(routines,
		extdef.Routine{Name: "l2_distance", Symbol: "l2_distance", Parameters: params("vector", "vector"), Returns: "float8", Strict: true, Impl: denseL2DistanceImpl("vector")},
		...
		extdef.Routine{Name: "cosine_distance", Symbol: "cosine_distance", Parameters: params("vector", "vector"), Returns: "float8", Strict: true, Impl: denseCosineDistanceImpl("vector")},
		extdef.Routine{Name: "l1_distance", Symbol: "l1_distance", Parameters: params("vector", "vector"), Returns: "float8", Strict: true, Impl: denseL1DistanceImpl("vector")},
	...
	routines = append(routines,
		...
		extdef.Routine{Name: "vector_negative_inner_product", Symbol: "vector_negative_inner_product", Parameters: params("vector", "vector"), Returns: "float8", Strict: true, Impl: denseNegativeInnerProductImpl("vector")},
	...
	routines = append(routines,
		extdef.Routine{Name: "l2_distance", Symbol: "halfvec_l2_distance", Parameters: params("halfvec", "halfvec"), Returns: "float8", Strict: true, Impl: denseL2DistanceImpl("halfvec")},
		...
		extdef.Routine{Name: "cosine_distance", Symbol: "halfvec_cosine_distance", Parameters: params("halfvec", "halfvec"), Returns: "float8", Strict: true, Impl: denseCosineDistanceImpl("halfvec")},
		extdef.Routine{Name: "l1_distance", Symbol: "halfvec_l1_distance", Parameters: params("halfvec", "halfvec"), Returns: "float8", Strict: true, Impl: denseL1DistanceImpl("halfvec")},
	...
	routines = append(routines,
		...
		extdef.Routine{Name: "halfvec_negative_inner_product", Symbol: "halfvec_negative_inner_product", Parameters: params("halfvec", "halfvec"), Returns: "float8", Strict: true, Impl: denseNegativeInnerProductImpl("halfvec")},
