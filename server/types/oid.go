...
var _ DoltgresTypeInterface = OidType{}
...
func (b OidType) deserializeType(version uint16, metadata []byte) (DoltgresTypeInterface, error) {
	switch version {
	case 0:
		return Oid, nil
	default:
...
func compareUint32(b DoltgresTypeInterface, v1, v2 any) (int, error) {
	if v1 == nil && v2 == nil {
		return 0, nil
