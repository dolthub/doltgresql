...
var _ DoltgresTypeInterface = UnknownType{}
...
func (u UnknownType) BaseType() DoltgresTypeInterface {
	return Unknown
}
...
func (u UnknownType) deserializeType(version uint16, metadata []byte) (DoltgresTypeInterface, error) {
