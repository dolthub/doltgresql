...
var _ DoltgresTypeInterface = ResolvableType{}
...
func (b ResolvableType) Type() query.Type {
	panic("ResolvableType is a placeholder type, but DoltgresType() was called")
}
...
func (b ResolvableType) deserializeType(version uint16, metadata []byte) (DoltgresTypeInterface, error) {
