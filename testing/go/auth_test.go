...
func TestAlterDefaultPrivileges(t *testing.T) {
	RunScripts(t, []ScriptTest{
		{
			Name: "ALTER DEFAULT PRIVILEGES basic grant",
			SetUpScript: []string{
				"CREATE ROLE testrole;",
				"CREATE ROLE grantee1;",
			},
			Assertions: []ScriptTestAssertion{
				{
					Query:    "ALTER DEFAULT PRIVILEGES FOR ROLE testrole GRANT SELECT ON TABLES TO grantee1;",
					Expected: []sql.Row{},
				},
				{
					Query:    "SELECT COUNT(*) FROM pg_catalog.pg_default_acl;",
					Expected: []sql.Row{{1}},
				},
				{
					Query:    "SELECT defaclobjtype FROM pg_catalog.pg_default_acl;",
					Expected: []sql.Row{{"r"}},
				},
			},
		},
		{
			Name: "ALTER DEFAULT PRIVILEGES FOR ROLE multiple privileges",
			SetUpScript: []string{
				"CREATE ROLE owner1;",
				"CREATE ROLE recipient1;",
			},
			Assertions: []ScriptTestAssertion{
				{
					Query:    "ALTER DEFAULT PRIVILEGES FOR ROLE owner1 GRANT SELECT, INSERT ON TABLES TO recipient1;",
					Expected: []sql.Row{},
				},
				{
					Query:    "SELECT COUNT(*) FROM pg_catalog.pg_default_acl;",
				...
				{
					Query:    "ALTER DEFAULT PRIVILEGES FOR ROLE owner1 GRANT USAGE ON SEQUENCES TO recipient1;",
					Expected: []sql.Row{},
				},
				{
					Query:    "SELECT COUNT(*) FROM pg_catalog.pg_default_acl;",
		...
		{
			Name: "ALTER DEFAULT PRIVILEGES FOR USER (synonym for FOR ROLE)",
			SetUpScript: []string{
				"CREATE ROLE userrole;",
				"CREATE ROLE grantee2;",
			},
			Assertions: []ScriptTestAssertion{
				{
					Query:    "ALTER DEFAULT PRIVILEGES FOR USER userrole GRANT EXECUTE ON FUNCTIONS TO grantee2;",
					Expected: []sql.Row{},
				},
				{
					Query:    "SELECT defaclobjtype FROM pg_catalog.pg_default_acl;",
		...
		{
			Name: "ALTER DEFAULT PRIVILEGES without FOR ROLE uses current user",
			SetUpScript: []string{
				"CREATE ROLE grantee3;",
			},
			Assertions: []ScriptTestAssertion{
				{
					Query:    "ALTER DEFAULT PRIVILEGES GRANT SELECT ON TABLES TO grantee3;",
					Expected: []sql.Row{},
				},
				{
					Query:    "SELECT COUNT(*) FROM pg_catalog.pg_default_acl;",
		...
		{
			Name: "ALTER DEFAULT PRIVILEGES REVOKE removes the entry",
			SetUpScript: []string{
				"CREATE ROLE ownerrole;",
				"CREATE ROLE granteex;",
			},
			Assertions: []ScriptTestAssertion{
				{
					Query:    "ALTER DEFAULT PRIVILEGES FOR ROLE ownerrole GRANT SELECT ON TABLES TO granteex;",
					Expected: []sql.Row{},
				},
				{
					Query:    "SELECT COUNT(*) FROM pg_catalog.pg_default_acl;",
				...
				{
					Query:    "ALTER DEFAULT PRIVILEGES FOR ROLE ownerrole REVOKE SELECT ON TABLES FROM granteex;",
					Expected: []sql.Row{},
				},
				{
					Query:    "SELECT COUNT(*) FROM pg_catalog.pg_default_acl;",
