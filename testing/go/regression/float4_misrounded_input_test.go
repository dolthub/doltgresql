...
func TestFloat4MisroundedInput(t *testing.T) {
	t.Skip()
	_ = RunTests(t, RegressionFileName_float4_misrounded_input)
}

func init() {
	RegisterRegressionFile(RegressionFile{
		RegressionFileName: RegressionFileName_float4_misrounded_input,
