	...
	RunScripts(t, []ScriptTest{
		{
			...
			Assertions: []ScriptTestAssertion{
				...
				},
				{
					...
					Expected: []sql.Row{{"982384720.120000"}},
				},
				{
					Query:    `SELECT EXTRACT(EPOCH FROM TIMESTAMP '2001-02-16 20:38:40.12');`,
					Expected: []sql.Row{{"982355920.120000"}},
				},
				{
				...
				},
				{
					...
					Expected: []sql.Row{{"40.000000"}},
				},
				{
					Query:    `SELECT EXTRACT(SECOND FROM TIME '17:12:28.5');`,
					Expected: []sql.Row{{"28.500000"}},
				},
				{
		...
		},
		{
			...
			Assertions: []ScriptTestAssertion{
				...
				},
				{
					...
					Expected: []sql.Row{{"442800.000000"}},
				},
				{
					Query:    `select extract(epoch from interval '10 months 10 seconds');`,
					Expected: []sql.Row{{"25920010.000000"}},
				},
				{
