...
public class PostgresTest {
    ...
    private static final PostgresTest[] tests = {
        ...
        new PostgresTest("select length(dolt_commit('-m', 'my commit')::text)", null, 1, new String[]{"32"}),
        ...
        new PostgresTest("select length(dolt_commit('-a', '-m', 'my commit2')::text)", null, 1, new String[]{"32"}),
