...
func TestCreateDomain(t *testing.T) {
	tests := []QueryParses{
		Parses("CREATE DOMAIN name data_type"),
		Parses("CREATE DOMAIN name AS data_type"),
		Parses("CREATE DOMAIN name data_type COLLATE en_US"),
		Parses("CREATE DOMAIN name AS data_type COLLATE en_US"),
		Parses("CREATE DOMAIN name data_type DEFAULT expression"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression"),
		...
		Parses("CREATE DOMAIN name data_type NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type NOT NULL"),
		Parses("CREATE DOMAIN name data_type COLLATE en_US NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type COLLATE en_US NOT NULL"),
		Parses("CREATE DOMAIN name data_type DEFAULT expression NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type CONSTRAINT constraint_name NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type CONSTRAINT constraint_name NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression CONSTRAINT constraint_name NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression CONSTRAINT constraint_name NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type NULL"),
		Parses("CREATE DOMAIN name AS data_type NULL"),
		Parses("CREATE DOMAIN name data_type COLLATE en_US NULL"),
		Parses("CREATE DOMAIN name AS data_type COLLATE en_US NULL"),
		Parses("CREATE DOMAIN name data_type DEFAULT expression NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression NULL"),
		...
		Parses("CREATE DOMAIN name data_type CONSTRAINT constraint_name NULL"),
		Parses("CREATE DOMAIN name AS data_type CONSTRAINT constraint_name NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression CONSTRAINT constraint_name NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression CONSTRAINT constraint_name NULL"),
		...
		Parses("CREATE DOMAIN name data_type NOT NULL NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type NOT NULL NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression NOT NULL NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression NOT NULL NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type CONSTRAINT constraint_name NOT NULL NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type CONSTRAINT constraint_name NOT NULL NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression CONSTRAINT constraint_name NOT NULL NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression CONSTRAINT constraint_name NOT NULL NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type NOT NULL CONSTRAINT constraint_name NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type NOT NULL CONSTRAINT constraint_name NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression NOT NULL CONSTRAINT constraint_name NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression NOT NULL CONSTRAINT constraint_name NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type CONSTRAINT constraint_name NOT NULL CONSTRAINT constraint_name NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type CONSTRAINT constraint_name NOT NULL CONSTRAINT constraint_name NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression CONSTRAINT constraint_name NOT NULL CONSTRAINT constraint_name NOT NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression CONSTRAINT constraint_name NOT NULL CONSTRAINT constraint_name NOT NULL"),
		...
		Parses("CREATE DOMAIN name data_type NULL NULL"),
		Parses("CREATE DOMAIN name AS data_type NULL NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression NULL NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression NULL NULL"),
		...
		Parses("CREATE DOMAIN name data_type CONSTRAINT constraint_name NULL NULL"),
		Parses("CREATE DOMAIN name AS data_type CONSTRAINT constraint_name NULL NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression CONSTRAINT constraint_name NULL NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression CONSTRAINT constraint_name NULL NULL"),
		...
		Parses("CREATE DOMAIN name data_type NULL CONSTRAINT constraint_name NULL"),
		Parses("CREATE DOMAIN name AS data_type NULL CONSTRAINT constraint_name NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression NULL CONSTRAINT constraint_name NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression NULL CONSTRAINT constraint_name NULL"),
		...
		Parses("CREATE DOMAIN name data_type CONSTRAINT constraint_name NULL CONSTRAINT constraint_name NULL"),
		Parses("CREATE DOMAIN name AS data_type CONSTRAINT constraint_name NULL CONSTRAINT constraint_name NULL"),
		...
		Parses("CREATE DOMAIN name data_type DEFAULT expression CONSTRAINT constraint_name NULL CONSTRAINT constraint_name NULL"),
		Parses("CREATE DOMAIN name AS data_type DEFAULT expression CONSTRAINT constraint_name NULL CONSTRAINT constraint_name NULL"),
