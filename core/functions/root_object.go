...
func (pgf *Collection) GetID() rootobject.RootObjectID {
	return rootobject.RootObjectID_Functions
}

// GetRootObject implements the interface rootobject.Collection.
func (pgf *Collection) GetRootObject(ctx context.Context, identifier id.Id) (rootobject.RootObject, bool, error) {
	if identifier.Section() != id.Section_Function {
...
func (pgf *Collection) IterateIDs(ctx context.Context, callback func(identifier id.Id) (stop bool, err error)) error {
...
func (pgf *Collection) IterateRootObjects(ctx context.Context, callback func(rootObj rootobject.RootObject) (stop bool, err error)) error {
...
func (pgf *Collection) PutRootObject(ctx context.Context, rootObj rootobject.RootObject) error {
